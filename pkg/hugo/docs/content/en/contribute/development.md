...
We're going to clone the [master Hugo repository](https://github.com/sunwei/hugoverse/pkg/hugo). That seems counter-intuitive, since you won't have commit rights on it. But it's required for the Go workflow. You'll work on a copy of the master and push your changes to your own repository on GitHub.
...
mkdir $HOME/src
cd $HOME/src
git clone https://github.com/sunwei/hugoverse/pkg/hugo.git
```
...
Open the [Hugo repository](https://github.com/sunwei/hugoverse/pkg/hugo) on GitHub and click on the "Fork" button in the top right.
...
origin  https://github.com/sunwei/hugoverse/pkg/hugo (fetch)
origin  https://github.com/sunwei/hugoverse/pkg/hugo (push)
```
...
Once you made your additions commit your changes. Make sure that you follow our [code contribution guidelines](https://github.com/sunwei/hugoverse/pkg/hugo/blob/master/CONTRIBUTING.md):
...
We made a lot of progress. Good work. In this step we finally open a pull request to submit our additions. Open the [Hugo master repository](https://github.com/sunwei/hugoverse/pkg/hugo/) on GitHub in your browser.
...
[contributors]: https://github.com/sunwei/hugoverse/pkg/hugo/graphs/contributors
...
[newissue]: https://github.com/sunwei/hugoverse/pkg/hugo/issues/new
