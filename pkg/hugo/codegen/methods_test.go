...
func TestMethods(t *testing.T) {
	...
	t.Run("MethodsFromTypes", func(t *testing.T) {
		...
		c.Assert(methods.Imports(), qt.Contains, "github.com/sunwei/hugoverse/pkg/hugo/common/herrors")
	})
	...
	t.Run("ToMarshalJSON", func(t *testing.T) {
		...
		c.Assert(pkg, qt.Contains, "github.com/sunwei/hugoverse/pkg/hugo/common/herrors")
