...
import (
	...
	"github.com/sunwei/hugoverse/pkg/hugo/common/hexec"

	"github.com/sunwei/hugoverse/pkg/hugo/common/hugio"
...
var (
	textTemplateReplacers = strings.NewReplacer(
		`"text/template/`, `"github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/texttemplate/`,
		`"internal/fmtsort"`, `"github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/fmtsort"`,
		`"internal/testenv"`, `"github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/testenv"`,
	...
	testEnvReplacers = strings.NewReplacer(
		`"internal/cfg"`, `"github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/cfg"`,
	)

	htmlTemplateReplacers = strings.NewReplacer(
		`. "html/template"`, `. "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/htmltemplate"`,
		`"html/template"`, `template "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/htmltemplate"`,
		"\"text/template\"\n", "template \"github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/texttemplate\"\n",
...
var goPackages = []goPackage{
	...
	},
	{
		...
		rewriter: func(name string) {
			...
			rewrite(name, `"text/template/parse" -> "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/texttemplate/parse"`)
		},
	},
	{srcPkg: "internal/fmtsort", dstPkg: "fmtsort", rewriter: func(name string) {
		rewrite(name, `"internal/fmtsort" -> "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/fmtsort"`)
	}},
	{
		...
		replacer: func(name, content string) string { return testEnvReplacers.Replace(content) }, rewriter: func(name string) {
			rewrite(name, `"internal/testenv" -> "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/testenv"`)
		},
	},
	{srcPkg: "internal/cfg", dstPkg: "cfg", rewriter: func(name string) {
		rewrite(name, `"internal/cfg" -> "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/cfg"`)
	}},
}
