...
Example
	...
	import template "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/texttemplate"
	...
...
but the contextual autoescaping in html/template
	...
	import template "github.com/sunwei/hugoverse/pkg/hugo/tpl/internal/go_templates/htmltemplate"
	...
	t, err := template.New("foo").Parse(`{{define "T"}}Hello, {{.}}!{{end}}`)
	err = t.ExecuteTemplate(out, "T", "<script>alert('you have been pwned')</script>")
