...
var i18nTests = []i18nTest{
	...
	// https://github.com/sunwei/hugoverse/pkg/hugo/issues/7787
	{
...
`),
	...
	// https://github.com/sunwei/hugoverse/pkg/hugo/issues/2607
	{
...
other = "a2 count {{ .Count }}"`),
	...
	// https://github.com/sunwei/hugoverse/pkg/hugo/issues/7798
	{
...
one =  "abc"`),
	...
	// https://github.com/sunwei/hugoverse/pkg/hugo/issues/7794
	{
...
`),
	...
	// https: //github.com/sunwei/hugoverse/pkg/hugo/issues/7804
	{
