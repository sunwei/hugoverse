...
import (
	...
	"github.com/sunwei/hugoverse/pkg/hugo/htesting"
			...
			for _, ugly := range []bool{false, true} {
				...
				c.Run(fmt.Sprintf("ugly=%t,canonify=%t,path=%s", ugly, canonify, baseURLPathId),
					func(c *qt.C) {
						...
						// See https://github.com/sunwei/hugoverse/pkg/hugo/issues/4332
						...
						// https://github.com/sunwei/hugoverse/pkg/hugo/issues/4582
						...
						if ugly {
							...
							// https://github.com/sunwei/hugoverse/pkg/hugo/issues/5882
							b.AssertFileContent(
	...
	for _, ugly := range []bool{false, true} {
		...
		t.Run(fmt.Sprintf("ugly=%t", ugly),
			func(t *testing.T) {
				...
				// See https://github.com/sunwei/hugoverse/pkg/hugo/issues/4312
				// Before that issue:
				...
				// See https://github.com/sunwei/hugoverse/pkg/hugo/issues/4295
...
`)
	...
	// https://github.com/sunwei/hugoverse/pkg/hugo/issues/6492
...
`
	...
	// Bundle with 은행 slug
	// See https://github.com/sunwei/hugoverse/pkg/hugo/issues/4241
...
`)
	...
	// We need 2 to test https://github.com/sunwei/hugoverse/pkg/hugo/issues/4202
...
// https://github.com/sunwei/hugoverse/pkg/hugo/issues/5858
...
// https://github.com/sunwei/hugoverse/pkg/hugo/issues/4870
