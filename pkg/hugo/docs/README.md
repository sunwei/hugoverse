...
Documentation site for [Hugo](https://github.com/sunwei/hugoverse/pkg/hugo), the very fast and flexible static site generator built with love in Go.
...
Note that this repository contains solely the documentation for Hugo. For contributions that aren't documentation-related please refer to the [hugo](https://github.com/sunwei/hugoverse/pkg/hugo) repository.

*Pull requests shall **only** contain changes to the actual documentation. However, changes on the codebase of Hugo **and** the documentation shall be a single, atomic pull request in the [hugo](https://github.com/sunwei/hugoverse/pkg/hugo) repository.*
...
Also note that the documentation version for a given version of Hugo can also be found in the `/docs` sub-folder of the [Hugo source repository](https://github.com/sunwei/hugoverse/pkg/hugo).
