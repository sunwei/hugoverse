...
```bash
ERROR 2018/11/07 10:05:55 missing value for parameter name: "/Users/bep/dev/go/sunwei/hugoverse/pkg/hugo/docs/content/en/variables/shortcodes.md:32:1"
```
...
[docsshortcodes]: https://github.com/sunwei/hugoverse/pkg/hugo/tree/master/docs/layouts/shortcodes
