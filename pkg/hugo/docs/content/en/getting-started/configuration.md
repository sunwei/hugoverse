...
- The `<language>` element in the internal [RSS template](https://github.com/sunwei/hugoverse/pkg/hugo/blob/master/tpl/tplimpl/embedded/templates/_default/rss.xml)
- The `lang` attribute of the `<html>` element in the internal [alias template](https://github.com/sunwei/hugoverse/pkg/hugo/blob/master/tpl/tplimpl/embedded/templates/alias.html)
